...
var I18N = {
  en:{
    ...
    background:"Background", bgStyle:"Style", bgGradient:"Gradient", bgImage:"Image", bgImageDesc:"Use your own photo as wallpaper", bgLive:"Live",
  ...
  zh:{
    ...
    background:"背景", bgStyle:"样式", bgGradient:"渐变", bgImage:"图片", bgImageDesc:"使用你自己的照片作为壁纸", bgLive:"动态",
  ...
  es:{
    ...
    background:"Fondo", bgStyle:"Estilo", bgGradient:"Degradado", bgImage:"Imagen", bgImageDesc:"Usa tu propia foto como fondo", bgLive:"Dinámico",
...
(function(){
  var extra={
    en:{
      ...
      monNoHost:"Set a metrics source to see NAS stats.", monConfigure:"Configure", monMetricsErr:"Couldn’t reach the metrics source.",
    ...
    zh:{
      ...
      monNoHost:"设置指标来源以查看 NAS 状态。", monConfigure:"去配置", monMetricsErr:"无法连接到指标来源。",
    ...
    es:{
      ...
      monNoHost:"Configura una fuente de métricas para ver el NAS.", monConfigure:"Configurar", monMetricsErr:"No se pudo conectar con la fuente de métricas.",
