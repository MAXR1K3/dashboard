...
var I18N = {
  en:{
    customizeTitle:"Customize name & logo", searchPh:"Search bookmarks…", theme:"Toggle theme", view:"Grid / compact",
    ...
    chromeSyncReplace:"Replace on sync", chromeSyncReplaceDesc:"Clear local bookmarks and categories, then rebuild them from Chrome. Matches the import “Replace everything” behavior.",
  ...
  zh:{
    customizeTitle:"自定义名称和图标", searchPh:"搜索书签…", theme:"切换主题", view:"网格 / 紧凑",
    ...
    chromeSyncReplace:"同步时替换全部", chromeSyncReplaceDesc:"先清空本地书签和分类，再按 Chrome 重新生成；规则与导入里的“替换全部”一致。",
  ...
  es:{
    customizeTitle:"Personalizar nombre y logo", searchPh:"Buscar marcadores…", theme:"Cambiar tema", view:"Cuadrícula / compacta",
    ...
    chromeSyncReplace:"Reemplazar al sincronizar", chromeSyncReplaceDesc:"Borra marcadores y categorías locales y los reconstruye desde Chrome. Igual que “Reemplazar todo” al importar.",
...
(function(){
  var extra={
    en:{
      ...
      syncModeDesc_replaceAll:"Clear all local bookmarks and categories, then rebuild from this source.",
      ...
      setTabGeneral:"General", setTabAppearance:"Appearance", setTabDashboard:"Dashboard", setTabServices:"Monitor & AI", setTabLog:"Activity log",
    ...
    zh:{
      ...
      syncModeDesc_replaceAll:"清空本地全部书签和分类，再按当前来源重新生成。",
      ...
      setTabGeneral:"通用", setTabAppearance:"外观", setTabDashboard:"仪表盘", setTabServices:"监控 & AI", setTabLog:"操作日志",
    ...
    es:{
      ...
      syncModeDesc_replaceAll:"Borra todos los marcadores y categorías locales y reconstruye desde esta fuente.",
      ...
      setTabGeneral:"General", setTabAppearance:"Apariencia", setTabDashboard:"Panel", setTabServices:"Monitor e IA", setTabLog:"Registro",
